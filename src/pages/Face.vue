...
<script>
  ...
  async function main() {
    let cameraId = await getInputDevices()
    console.log(' main')
  }
  ...
  async function getInputDevices() {
    ...
    console.log('devices')
    let cameraList = await gotDevices(videoDevices)
    let obj = {}
    for (let camera of cameraList) {
      obj[camera.label] = camera.deviceId
    }
    let arryCameraIds = Object.values(obj)
    // // await cameraChange(val)
    return arryCameraIds
  }
